...
import subprocess # gpt缺了。需要react ob 错误！修正错误
...
def run_ipython_code(code: str) -> str:
    """Runs Python code using a shell script and returns the result or error"""
    command = f'/Users/emacspy/.emacs.d/ec_py.sh "{code}"'
